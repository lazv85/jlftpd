...
public class ResponseCode{
    ...
    public static final int CODE_220_Service_ready_for_new_user = 220;
    public static final int CODE_221_Service_closing_control_connection = 221;
    public static final int CODE_225_Data_connection_open = 225;
    ...
    public static final int CODE_230_User_logged_in = 230;
    public static final int CODE_231_User_logged_out = 231;
    public static final int CODE_232_Logout_command_noted = 232;
    public static final int CODE_250_Requested_file_action_okay = 250;
    public static final int CODE_257_PATHNAME_created = 257;
    
    public static final int CODE_331_User_name_ok_need_password = 331;
    public static final int CODE_332_Need_account_for_login = 332;
    public static final int CODE_350_Requested_file_action_pending_information = 350;
    
    public static final int CODE_421_Service_not_available = 421;
    public static final int CODE_425_Cant_open_data_connection = 425;
    public static final int CODE_426_Connection_closed_aborted = 426;
    public static final int CODE_430_Invalid_username_or_password = 430;
    ...
    public static final int CODE_452_Requested_action_not_taken = 452;
    ...
    public static final int CODE_534_Cant_connect_to_server = 534;
    public static final int CODE_550_Requested_action_not_taken = 550;
    public static final int CODE_551_Requested_action_aborted = 551;
    public static final int CODE_552_Requested_file_action_aborted = 552;
    public static final int CODE_553_Requested_action_not_taken = 553;
